...
export const ChatgptLogo: React.FC<IconProps> = ({ size = 16, ...rest }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" aria-hidden="true" focusable="false" {...rest}>
...
/** kagi — monogram (10.17:1). No verified mark held. */
export const KagiLogo: React.FC<IconProps> = (props) => (
  <Monogram letters="Kg" color="#ffb319" ink="#151517" {...props} />
);
KagiLogo.displayName = "KagiLogo";

/** deepseek — monogram (4.33:1). No verified mark held. */
export const DeepseekLogo: React.FC<IconProps> = (props) => (
  <Monogram letters="Ds" color="#4d6bfe" ink="#ffffff" {...props} />
);
DeepseekLogo.displayName = "DeepseekLogo";

/** t3chat — monogram (5.55:1). No verified mark held. */
export const T3chatLogo: React.FC<IconProps> = (props) => (
  <Monogram letters="T3" color="#ca0277" ink="#ffffff" {...props} />
);
T3chatLogo.displayName = "T3chatLogo";

/** huggingchat — monogram (8.75:1). No verified mark held. */
export const HuggingchatLogo: React.FC<IconProps> = (props) => (
  <Monogram letters="Hf" color="#ff9d00" ink="#151517" {...props} />
);
HuggingchatLogo.displayName = "HuggingchatLogo";

/** duckai — monogram (4.82:1). No verified mark held. */
export const DuckaiLogo: React.FC<IconProps> = (props) => (
  <Monogram letters="Dd" color="#de5833" ink="#151517" {...props} />
);
DuckaiLogo.displayName = "DuckaiLogo";

/** kimi — monogram (17.40:1). No verified mark held. */
export const KimiLogo: React.FC<IconProps> = (props) => (
  <Monogram letters="Km" color="#1a1a1a" ink="#ffffff" {...props} />
);
KimiLogo.displayName = "KimiLogo";

/** cursor — monogram (21.00:1). No verified mark held. */
export const CursorLogo: React.FC<IconProps> = (props) => (
  <Monogram letters="Cu" color="#000000" ink="#ffffff" {...props} />
);
CursorLogo.displayName = "CursorLogo";

/** aistudio — monogram (5.12:1). No verified mark held. */
export const AistudioLogo: React.FC<IconProps> = (props) => (
  <Monogram letters="As" color="#4285f4" ink="#151517" {...props} />
);
AistudioLogo.displayName = "AistudioLogo";

/** github-copilot — monogram (4.53:1). No verified mark held. */
export const GithubCopilotLogo: React.FC<IconProps> = (props) => (
  <Monogram letters="Gh" color="#0078d4" ink="#ffffff" {...props} />
);
GithubCopilotLogo.displayName = "GithubCopilotLogo";

/** v0 — monogram (21.00:1). No verified mark held. */
export const V0Logo: React.FC<IconProps> = (props) => (
  <Monogram letters="v0" color="#000000" ink="#ffffff" {...props} />
);
V0Logo.displayName = "V0Logo";

/** scira — monogram (17.85:1). No verified mark held. */
export const SciraLogo: React.FC<IconProps> = (props) => (
  <Monogram letters="Sc" color="#0f172a" ink="#ffffff" {...props} />
);
